        ...
        <CompanyAdminDashboardLayout>
            <div className="mx-auto max-w-3xl pb-12">
                <div className="mt-8 text-center">
                    <h1 className="text-2xl font-bold text-gray-800">Tenant not found</h1>
                    <p className="mt-2 text-gray-500">The tenant you are looking for does not exist.</p>
                    <Link
                        href={tenantListHref()}
...
/** Tenant record shell — breadcrumb + full-width content (matches Leads / Work Orders). */
export function TenantDetailShell({ breadcrumbItems, children }: Props) {
    return (
