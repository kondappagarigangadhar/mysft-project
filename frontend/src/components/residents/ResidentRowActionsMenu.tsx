...
export function ResidentRowActionsMenu({
    ...
    const menuContent = (
        ...
        >
            <Link
                href={residentViewHref(resident.slug)}
            ...
            <Link href={`${residentViewHref(resident.slug)}?edit=1`} className={CTA_MENU_ITEM} onClick={() => setOpen(false)}>
