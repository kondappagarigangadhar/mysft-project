...
/** Same sentinel as Lead inline overview. */
...
/** Mirrors `FieldRow` in `LeadInlineOverviewEditor.tsx` for visual parity with Leads. */
export function ResidentFieldRow({ label, required, children, className }: FieldRowProps) {
    return (
        <div
            className={cn(
...
/** Mirrors `InlineCollapsibleSection` in `LeadInlineOverviewEditor.tsx`. */
export function ResidentCollapsibleSection({
    title,
    icon: Icon,
    tone = 'slate',
    open,
