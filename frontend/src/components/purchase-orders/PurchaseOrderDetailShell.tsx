...
export function PurchaseOrderNotFound() {
    return (
        <CompanyAdminDashboardLayout>
            <div className="mx-auto max-w-3xl pb-12">
                <div className="mt-8 text-center">
                    <h1 className="text-2xl font-bold text-gray-800">Purchase order not found</h1>
                    <p className="mt-2 text-gray-500">The purchase order you are looking for does not exist.</p>
                    <Link
...
export function PurchaseOrderDetailShell({ breadcrumbItems, children }: Props) {
    return (
